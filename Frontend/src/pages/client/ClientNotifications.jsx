...
const ClientNotifications = () => {
  ...
  const markRead = async (id) => { await apiPatch(`${WORKFLOW_API}/notifications/${id}/read`); load(); };
  const markAll = async () => { await apiPatch(`${WORKFLOW_API}/notifications/read-all`); load(); };
