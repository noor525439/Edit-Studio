        ...
        >
          ...
          <div className="flex flex-col justify-center">
            <h1 className="font-bold text-2xl tracking-tighter text-slate-900 flex items-center gap-1">
              EDIT
              <span className="bg-gradient-to-br from-green-400 to-emerald-600 text-white text-[9px] px-1.5 py-0.5 rounded-md font-bold uppercase">
                OS
              </span>
            </h1>
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-[0.45em]">
              STUDIO
            </span>
          </div>
        </Link>
          ...
          {user ? (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-64 p-3 rounded-2xl">
                <DropdownMenuLabel className="text-[9px] font-bold uppercase text-slate-400">
                  Active Session
                </DropdownMenuLabel>
                <p className="px-2 text-sm font-bold truncate">
                  {user?.username}
                </p>
                <DropdownMenuSeparator />
                ...
                <DropdownMenuItem
                  ...
                  className="cursor-pointer rounded-xl py-3 text-red-500"
                >
            ...
            <div className="flex items-center gap-4">
              <Link
                to="/login"
                className="text-[11px] font-bold uppercase text-slate-400 hover:text-slate-600"
              >
                Login
              </Link>
              <Link to="/signup">
