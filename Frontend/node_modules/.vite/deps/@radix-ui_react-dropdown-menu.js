...
import { t as require_jsx_runtime } from "./jsx-runtime-DyvJJqQb.js";
import { n as useCallbackRef, t as useLayoutEffect2 } from "./dist-DmIWekkU.js";
...
var import_react_dom$9 = /* @__PURE__ */ __toESM(require_react_dom(), 1);
/* @__NO_SIDE_EFFECTS__ */
...
var Primitive = [
	...
	const Slot$1 = createSlot$8(`Primitive.${node}`);
...
var Primitive$7 = [
	...
	const Slot$1 = createSlot$6(`Primitive.${node}`);
	const Node$1 = import_react.forwardRef((props, forwardedRef) => {
		const { asChild,...primitiveProps } = props;
		const Comp = asChild ? Slot$1 : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
function dispatchDiscreteCustomEvent$1(target, event) {
	if (target) import_react_dom$8.flushSync(() => target.dispatchEvent(event));
}
...
var Primitive$6 = [
	...
	const Slot$1 = createSlot$5(`Primitive.${node}`);
	const Node$1 = import_react.forwardRef((props, forwardedRef) => {
		const { asChild,...primitiveProps } = props;
		const Comp = asChild ? Slot$1 : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
var Primitive$5 = [
	...
	const Slot$1 = createSlot$4(`Primitive.${node}`);
	const Node$1 = import_react.forwardRef((props, forwardedRef) => {
		const { asChild,...primitiveProps } = props;
		const Comp = asChild ? Slot$1 : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
var Arrow$1 = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$5.svg, {
		...arrowProps,
		ref: forwardedRef,
		width,
		height,
...
var Primitive$4 = [
	...
	const Slot$1 = createSlot$3(`Primitive.${node}`);
	const Node$1 = import_react.forwardRef((props, forwardedRef) => {
		const { asChild,...primitiveProps } = props;
		const Comp = asChild ? Slot$1 : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
var PopperAnchor = import_react.forwardRef((props, forwardedRef) => {
	...
	return virtualRef ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$4.div, {
		...anchorProps,
		ref: composedRefs
	});
});
...
var Primitive$3 = [
	...
	const Slot$1 = createSlot$2(`Primitive.${node}`);
	const Node$1 = import_react.forwardRef((props, forwardedRef) => {
		const { asChild,...primitiveProps } = props;
		const Comp = asChild ? Slot$1 : node;
		if (typeof window !== "undefined") window[Symbol.for("radix-ui")] = true;
...
var Portal = import_react.forwardRef((props, forwardedRef) => {
	...
	return container ? import_react_dom$2.createPortal(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$3.div, {
		...portalProps,
		ref: forwardedRef
	}), container) : null;
});
...
var RovingFocusGroupItem = import_react.forwardRef((props, forwardedRef) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Collection$1.ItemSlot, {
		...
		focusable,
		active,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Primitive$2.span, {
